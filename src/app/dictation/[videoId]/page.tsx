...
export default function DictationPage({ params }: PageProps) {
  ...
  // ---- Render ----
  return (
    <div className="player-dark-theme relative flex min-h-svh h-auto w-full flex-col overflow-x-hidden overflow-y-auto bg-[var(--bg)] font-sans text-[var(--text)] antialiased md:h-dvh md:overflow-hidden">
      <input
        ref={srtFileInputRef}
        type="file"
        ...
        <AnimatePresence initial={false} mode="popLayout">
          {showLearningPanel && (
            <motion.div
              ...
              transition={{ duration: 0.3, ease: "easeInOut" }}
              className={clsx(
                "flex h-[min(100svh,750px)] min-h-[360px] w-full flex-col overflow-hidden pb-[env(safe-area-inset-bottom)]",
